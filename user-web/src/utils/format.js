/**
 * 国际化格式化工具（USR-I18N-03）
 * 使用 Intl API 替代 dayjs 硬编码格式，自动处理多语言/货币/数字本地化。
 *
 * 借鉴：
 *   - https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl
 *   - https://simplelocalize.io/blog/posts/vue-i18n-localization/
 */
...
/**
 * 获取当前 locale（zh / en / ja / ar / es / fr / de / ru / pt）
 */
