...
const formRules = {
  ...
  bucket: [{ required: true, message: i18n.global.t('请输入存储桶名称'), trigger: 'blur' }],
  accessKey: [{ required: true, message: i18n.global.t('请输入Access Key'), trigger: 'blur' }],
  secretKey: [{ required: true, message: i18n.global.t('请输入Secret Key'), trigger: 'blur' }],
  endpoint: [{ required: true, message: i18n.global.t('请输入节点域名'), trigger: 'blur' }],
  region: [{ required: true, message: i18n.global.t('请输入存储区域'), trigger: 'blur' }],
  basePath: [{ required: true, message: i18n.global.t('请输入存储路径'), trigger: 'blur' }]
}
