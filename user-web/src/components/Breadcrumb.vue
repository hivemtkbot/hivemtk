...
const subMenusMap = {
  ...
  order: { parent: 'customer', title: i18n.global.t('订单管理') },
  ...
  xianyu: { parent: 'reach', title: i18n.global.t('咸鱼') },
  xianyuCard: { parent: 'reach', title: i18n.global.t('咸鱼卡片') },
  ...
  aiContent: { parent: 'knowledge', title: i18n.global.t('AI 内容创作') },
  templateMarket: { parent: 'knowledge', title: i18n.global.t('模板市场') },
