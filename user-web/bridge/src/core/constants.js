...
// 注意：私信页 URL 实际为 https://www.douyin.com/follow 之类，
//       但官网根域名是稳定入口；用户已登录态下会展示「消息」入口
export const PLATFORM_ENTRY_URLS = {
  douyin_web: 'https://www.douyin.com/',
...
// =============================================================
// 6) 协议常量（与服务端 user-server/internal/bridge/frames.go 一一对应）
// =============================================================
