...
// ============================================================================
// PretranslateService 知识库预翻译服务（v1.2 出海多语言方案 P1-3）
// ----------------------------------------------------------------------------
// 五层架构归属：L3 业务服务层
//
// 设计目标：
...
//
// 依赖：
//   - ChunkReader：高频条目查询 + 翻译版本回填（由 repository 层实现，P2 补全）
//   - Translator：翻译接口（复用 fallback_bridge 的 Translator 接口，P2 补全）
//
