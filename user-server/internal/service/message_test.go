...
func TestMessageService_Register(t *testing.T) {
	...
	result, err := service.Register(message)
	if err != nil {
...
func TestMessageService_GetMessage(t *testing.T) {
	...
	registered, _ := service.Register(message)
...
func TestMessageService_GetMessageList_Pagination(t *testing.T) {
	...
	// Get first page
	messages, total, err := service.GetMessageList(1, 5)
	if err != nil {
		t.Fatalf("GetMessageList failed: %v", err)
	}
	...
	// Get second page
	messages2, _, err := service.GetMessageList(2, 5)
	if err != nil {
...
func TestMessageService_DeleteMessage(t *testing.T) {
	...
	err := service.DeleteMessage(registered.ID)
	if err != nil {
	...
	_, total, _ := service.GetMessageList(1, 10)
	if total == 0 {
...
func TestMessageService_InitMessage(t *testing.T) {
	...
	messageID, err := service.InitMessage("account123", "user456", 67890, "Init message text")
	if err != nil {
...
func TestMessageService_InitMessage_EmptyValues(t *testing.T) {
	...
	messageID, err := service.InitMessage("", "", 0, "")
	if err != nil {
...
func TestMessageService_Register_MultipleMessages(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		...
		_, err := service.Register(message)
		if err != nil {
...
func TestMessageService_InitMessage_DifferentUsers(t *testing.T) {
	...
	for i, user := range users {
		messageID, err := service.InitMessage("account123", user, int64(1000+i), "Message for "+user)
		if err != nil {
...
func TestMessageService_DeleteMessage_NonExistent(t *testing.T) {
	...
	err := service.DeleteMessage("non-existent-id")
	if err != nil {
