...
func (s *FeishuService) ListFeishuAccountVOs() ([]*FeishuAccountVO, error) {
...
func (s *FeishuService) GetFeishuAccountVO(id uint) (*FeishuAccountVO, error) {
...
func (s *FeishuService) CreateFeishuAccountVO(req FeishuAccountCreateReq) (*FeishuAccountVO, error) {
...
func (s *FeishuService) UpdateFeishuAccountVO(id uint, req FeishuAccountUpdateReq) (*FeishuAccountVO, error) {
	acc, err := s.GetAccount(id)
	if err != nil {
		return nil, err
	}
...
func (s *FeishuService) DeleteFeishuAccountVO(id uint) error {
...
func (s *WhatsAppCloudService) ListWhatsAppCloudAccountVOs() ([]*WhatsAppCloudAccountVO, error) {
	accs, err := s.ListAccounts()
	if err != nil {
		return nil, err
	}
...
func (s *WhatsAppCloudService) GetWhatsAppCloudAccountVO(id uint) (*WhatsAppCloudAccountVO, error) {
	acc, err := s.GetAccount(id)
	if err != nil {
		return nil, err
	}
...
func (s *WhatsAppCloudService) CreateWhatsAppCloudAccountVO(req WhatsAppCloudAccountCreateReq) (*WhatsAppCloudAccountVO, error) {
...
func (s *WhatsAppCloudService) UpdateWhatsAppCloudAccountVO(id uint, req WhatsAppCloudAccountUpdateReq) (*WhatsAppCloudAccountVO, error) {
	acc, err := s.GetAccount(id)
	if err != nil {
		return nil, err
	}
...
func (s *WhatsAppCloudService) DeleteWhatsAppCloudAccountVO(id uint) error {
	return s.DeleteAccount(id)
}
