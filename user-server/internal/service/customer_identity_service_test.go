...
func TestCustomerIdentityService_IdentifyOrCreate_Phone(t *testing.T) {
	...
	customer, err := service.IdentifyOrCreate(context.Background(), identifiers)
	if err != nil {
...
func TestCustomerIdentityService_IdentifyOrCreate_Priority(t *testing.T) {
	...
	second, err := service.IdentifyOrCreate(context.Background(), combinedIdentifiers)
	if err != nil {
...
func TestCustomerIdentityService_IdentifyOrCreate_NoIdentity(t *testing.T) {
	...
	_, err := service.IdentifyOrCreate(context.Background(), identifiers)
