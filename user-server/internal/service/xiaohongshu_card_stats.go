...
type XiaohongshuCardStatsService interface {
	GetCardStats(req *dto.XiaohongshuCardStatsRequest) (*dto.XiaohongshuCardStatsResponse, error)
	GetOverallStats(req *dto.XiaohongshuCardOverallStatsRequest) (*dto.XiaohongshuCardOverallStatsResponse, error)
...
func (s *xiaohongshuCardStatsService) GetCardStats(req *dto.XiaohongshuCardStatsRequest) (*dto.XiaohongshuCardStatsResponse, error) {
	// 查询卡片信息
...
func (s *xiaohongshuCardStatsService) GetOverallStats(req *dto.XiaohongshuCardOverallStatsRequest) (*dto.XiaohongshuCardOverallStatsResponse, error) {
	// 获取卡片总数和激活数
...
func (s *xiaohongshuCardStatsService) RecordActivity(cardID uint, userID uint, action string, username, ipAddress, userAgent string) error {
	// 只记录浏览活动
	if action != "view" {
		return nil
	}
