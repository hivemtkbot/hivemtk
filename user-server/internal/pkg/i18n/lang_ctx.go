...
// ============================================================================
// 多语言 ctx key（v1.2 出海多语言方案）
// ----------------------------------------------------------------------------
// 双语言模型：
//   - InternalLang：智能体内部语言（知识库语言 + 内部工具 prompt 语言）
//   - TargetLang  ：对外输出语言（按渠道配置，前端可见）
//   - CrossLingual：InternalLang != TargetLang，需要跨语言生成
//
// 与 locale.go 中 Locale（业务层提示本地化）解耦：
//   - Locale 适用于"Go 后端返回给前端的 API 文案"。
//   - 本文件适用于"LLM 调用 / 内容生成"链路，由 LangConfigResolver 注入。
// ============================================================================
