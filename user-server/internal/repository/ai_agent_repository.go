...
func (r *AIAgentRepository) SetDB(db *gorm.DB) {
	if db != nil {
		r.db = db
	}
}
...
// GetDB 获取 db（内部使用）
func (r *AIAgentRepository) GetDB() *gorm.DB {
	return r.db
}

// Create 创建智能体
func (r *AIAgentRepository) Create(agent *model.AIAgent) error {
	return r.db.Create(agent).Error
}

// GetByID 根据 ID 获取
func (r *AIAgentRepository) GetByID(id uint) (*model.AIAgent, error) {
	var a model.AIAgent
...
func (r *AIAgentRepository) GetByCode(code string) (*model.AIAgent, error) {
	var a model.AIAgent
...
func (r *AIAgentRepository) List(agentType string, status int, keyword string) ([]*model.AIAgent, error) {
...
func (r *AIAgentRepository) ListEnabled() ([]*model.AIAgent, error) {
	var list []*model.AIAgent
...
// Update 更新智能体
func (r *AIAgentRepository) Update(agent *model.AIAgent) error {
	return r.db.Save(agent).Error
}

// UpdateStatus 更新状态
func (r *AIAgentRepository) UpdateStatus(id uint, status int) error {
...
func (r *AIAgentRepository) Delete(id uint) error {
	return r.db.Delete(&model.AIAgent{}, id).Error
}

// CountByIDs 按ID集合统计数量（用于校验绑定挂载合法性）
func (r *AIAgentRepository) CountByIDs(ids []uint) (int64, error) {
	if len(ids) == 0 {
		return 0, nil
	}
	var count int64
...
// SetDB 注入 db
func (r *ChannelAgentBindingRepository) SetDB(db *gorm.DB) {
	if db != nil {
		r.db = db
	}
}
...
// Create 创建绑定
func (r *ChannelAgentBindingRepository) Create(b *model.ChannelAgentBinding) error {
	return r.db.Create(b).Error
}

// GetByID 根据 ID 获取
func (r *ChannelAgentBindingRepository) GetByID(id uint) (*model.ChannelAgentBinding, error) {
...
func (r *ChannelAgentBindingRepository) ListByChannelAccount(channelType, accountID string) ([]*model.ChannelAgentBinding, error) {
...
func (r *ChannelAgentBindingRepository) GetPrimaryByChannelAccount(channelType, accountID string) (*model.ChannelAgentBinding, error) {
	var b model.ChannelAgentBinding
	err := r.db.Where("channel_type = ? AND account_id = ? AND is_primary = ? AND enabled = ?",
...
func (r *ChannelAgentBindingRepository) ListByAgentID(agentID uint) ([]*model.ChannelAgentBinding, error) {
	var list []*model.ChannelAgentBinding
...
// Update 更新绑定
func (r *ChannelAgentBindingRepository) Update(b *model.ChannelAgentBinding) error {
	return r.db.Save(b).Error
}

// Delete 删除绑定
func (r *ChannelAgentBindingRepository) Delete(id uint) error {
	return r.db.Delete(&model.ChannelAgentBinding{}, id).Error
}

// ClearPrimaryByChannelAccount 清除指定渠道账号下的所有主绑定标记
// 用于切换主智能体时先清空再设置
func (r *ChannelAgentBindingRepository) ClearPrimaryByChannelAccount(channelType, accountID string) error {
...
func (r *ChannelAgentBindingRepository) DeleteByChannelAccount(channelType, accountID string) error {
...
// SetDB 注入 db
func (r *CustomerServiceAgentRepository) SetDB(db *gorm.DB) {
	if db != nil {
		r.db = db
	}
}
...
// Create 创建挂载
func (r *CustomerServiceAgentRepository) Create(c *model.CustomerServiceAgent) error {
	return r.db.Create(c).Error
}

// GetByID 根据 ID 获取
func (r *CustomerServiceAgentRepository) GetByID(id uint) (*model.CustomerServiceAgent, error) {
...
func (r *CustomerServiceAgentRepository) ListByAgentStatusID(agentStatusID uint) ([]*model.CustomerServiceAgent, error) {
...
// 返回 nil, nil 表示未挂载
func (r *CustomerServiceAgentRepository) GetPrimaryByAgentStatusID(agentStatusID uint) (*model.CustomerServiceAgent, error) {
	var c model.CustomerServiceAgent
...
func (r *CustomerServiceAgentRepository) ListByAIAgentID(aiAgentID uint) ([]*model.CustomerServiceAgent, error) {
	var list []*model.CustomerServiceAgent
...
// Update 更新挂载
func (r *CustomerServiceAgentRepository) Update(c *model.CustomerServiceAgent) error {
	return r.db.Save(c).Error
}

// Delete 删除挂载
func (r *CustomerServiceAgentRepository) Delete(id uint) error {
	return r.db.Delete(&model.CustomerServiceAgent{}, id).Error
}

// ClearPrimaryByAgentStatusID 清除指定座席下所有主挂载标记
func (r *CustomerServiceAgentRepository) ClearPrimaryByAgentStatusID(agentStatusID uint) error {
...
func (r *CustomerServiceAgentRepository) DeleteByAgentStatusID(agentStatusID uint) error {
