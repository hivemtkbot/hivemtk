...
func TestCustomerRepository_Update(t *testing.T) {
	...
	// Verify update
	updated, err := repo.GetByIDcustomer.ID)
	if err != nil {
		t.Errorf("GetByID() error = %v", err)
	}
...
func TestCustomerRepository_Delete(t *testing.T) {
	...
	// Verify deletion
	deleted, err := repo.GetByIDcustomer.ID)
	if err != nil {
		t.Errorf("GetByID() error = %v", err)
	}
...
func TestCustomerRepository_Tags(t *testing.T) {
	...
	result, err := repo.GetByIDcustomer.ID)
	if err != nil {
		t.Errorf("GetByID() error = %v", err)
	}
...
func TestCustomerRepository_ChurnRiskAndRFM(t *testing.T) {
	...
	updated, err := repo.GetByIDresult.ID)
	if err != nil {
		t.Errorf("GetByID() error = %v", err)
	}
