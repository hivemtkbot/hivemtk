...
func TestOrderRepository_Create_MultipleOrders(t *testing.T) {
	...
	orders, total, err := repo.GetOrderList(1, 10)
	if err != nil {
...
func TestOrderRepository_GetOrderList(t *testing.T) {
	...
	orders, total, err := repo.GetOrderList(1, 5)
	if err != nil {
		t.Fatalf("GetOrderList failed: %v", err)
	}
...
func TestOrderRepository_LastOrderIsPay_True(t *testing.T) {
	...
	result := repo.LastOrderIsPay("account123", 12345)
	if !result {
...
func TestOrderRepository_LastOrderIsPay_NoOrder(t *testing.T) {
	...
	result := repo.LastOrderIsPay("nonexistent", 99999)
	if result {
...
func TestOrderRepository_GetGetLastOrder(t *testing.T) {
	...
	lastOrder, err := repo.GetGetLastOrder("account123", 12345)
	if err != nil {
...
func TestOrderRepository_GetGetLastOrder_NotFound(t *testing.T) {
	...
	_, err := repo.GetGetLastOrder("nonexistent", 99999)
	if err == nil {
...
func TestOrderRepository_UpdateOrderStatusById(t *testing.T) {
	...
	err := repo.UpdateOrderStatusById(order.ID, _type.OrderStatusSuccess)
	if err != nil {
		t.Fatalf("UpdateOrderStatusById failed: %v", err)
	}

	// Verify by getting the last order
	updatedOrder, _ := repo.GetGetLastOrder("account123", 12345)
...
func TestOrderRepository_UpdateOrderStatusById_NotFound(t *testing.T) {
	...
	err := repo.UpdateOrderStatusById("non-existent-id", _type.OrderStatusSuccess)
	if err == nil {
		t.Error("Expected error for non-existent order")
	}
}
...
func TestOrderRepository_GetRecentOrderList(t *testing.T) {
	...
	orders, err := repo.GetRecentOrderList()
	if err != nil {
...
func TestOrderRepository_GetOrderList_WithDifferentStatus(t *testing.T) {
	...
	_, total, err := repo.GetOrderList(1, 10)
	if err != nil {
		t.Fatalf("GetOrderList failed: %v", err)
	}
...
func TestOrderRepository_Create_LargeBatch(t *testing.T) {
	...
	orders, total, err := repo.GetOrderList(1, 50)
	if err != nil {
		t.Fatalf("GetOrderList failed: %v", err)
	}
...
func TestOrderRepository_GetGetLastOrder_MultipleUsers(t *testing.T) {
	...
	lastOrder, err := repo.GetGetLastOrder("account0", 10000)
	if err != nil {
		t.Fatalf("GetGetLastOrder failed: %v", err)
	}
