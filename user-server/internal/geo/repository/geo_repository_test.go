...
func setupGeoTestDB(t *testing.T) {
...
func TestGeoPlatformAccountRepository(t *testing.T) {
	setupGeoTestDB(t)
	repo := NewGeoPlatformAccountRepository()
...
func TestGeoKnowledgeDocumentRepository(t *testing.T) {
	setupGeoTestDB(t)
	repo := NewGeoKnowledgeDocumentRepository()
