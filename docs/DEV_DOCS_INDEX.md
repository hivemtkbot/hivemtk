...
部分工程在标准 4 份文档之外，保留了历史功能清单作为参考，不在标准文档体系内：

| 工程目录 | 文件名 | 路径 | 说明 |
| --- | --- | --- | --- |
| user-server | `NEW_FUNCTIONS_INVENTORY.md` | `hivemtk/user-server/docs/dev/NEW_FUNCTIONS_INVENTORY.md` | 函数清单，作为历史功能清单参考，不纳入标准 4 份文档体系 |
